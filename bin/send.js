...
module.exports = function(config, body){
  ...
  if(!mail_opts.server && mail_opts.login && mail_opts.login.match(/^.*@gmail.com$/)){
    using_gmail = true;
  } else if (typeof mail_opts.server === 'undefined') {
    return console.log('No server setting found');
  }
  ...
  if(typeof mail_opts.from === 'undefined') mail_opts.from = '';
