...
var App = function (options, cwd, envVars) {
  ...
  this.chain = new taj('', {
    ...
    mergeStyles: require('./mergeStylesRegex'),
...
App.prototype = {
  ...
  compile: function () {
    ...
    .buildLessFile(css_inline_path, less_inline_path, this.options)
    .buildLessFile(css_embed_path, less_embed_path, this.options)
